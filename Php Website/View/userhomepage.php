...
<body>
    ...
    <header>
        <a href='../Controller/loginhomepageController.php'>Recipes For Disaster</a>
        ...
        <nav class="dropdown">
            <form id="searchForm" action="../Controller/loginhomepageController.php" method="POST">
            ...
            <a href="../Controller/loginhomepageController.php"><input type="submit" value="Clear Search"></a>
            ...
            <div class="nav_buttons">
                ...
                <a href="../Controller/HomepageController.php"><input type="submit" value="Log out"></a>
            </div>
        </nav>
    </header>
        ...
        <?php foreach ($results as $recipe): ?>
            ...
            <div class="card-content">
                ...
                <div class="card-buttons">
                    ...
                    <span>&nbsp;</span>
                    <a href="../Controller/loginhomepageController.php?invite=<?= $recipe->id ?>" class="button">Add to
                        Cart</a>
                </div>
            </div>
        <?php endforeach ?>
