...
<body>
    ...
    <header>
        <a href='../Controller/recipeadd_controller.php'>Recipes For Disaster</a>
        ...
        <nav class="dropdown">
            <form id="searchForm" action="../Controller/recipeadd_controller.php" method="POST">
            ...
            <a href="../Controller/recipeadd_controller.php"><input type="submit" value="Clear Search"></a>

            <div class="nav_buttons">
                <a href="../Controller/checkout_controller.php"><input type="submit" value="Show Cart"></a>
                <span>
                    <?= count($basket) ?> Cart
                </span>
        ...
        <?php foreach ($results as $recipe): ?>
            ...
            <div class="card-content">
                ...
                <div class="card-buttons">
                    ...
                    <span>&nbsp;</span>
                    <a href="../Controller/recipeadd_controller.php?invite=<?= $recipe->id ?>" class="button">Add to
                        Cart</a>
                </div>
            </div>
        <?php endforeach ?>
